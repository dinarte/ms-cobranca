...
public class DynamicMenuInterception implements HandlerInterceptor {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if (handler instanceof HandlerMethod) {
			...
			menuService.getMenuItens().forEach(m -> { 
			 ...
			 * 
			 * if (node.getItem() == null) System.out.println("NULL: " +
			 * node.getHierarchy());
			 * 
			 * System.out.println(node.getItem().getName() + " (" +node.getItem().getPath()+
			 * ") ");
			 * 
			 * node.getChildren().forEach(node2-> { if (node2.getItem() == null)
			 * System.out.println("NULL: " + node2.getHierarchy());
			 * 
			 * System.out.println(">>>>>>>" + node2.getItem().getName() + " ("
			 * +node2.getItem().getPath()+ ") "); node2.getChildren().forEach(node3-> {
			 * 
			 * if (node3.getItem() == null) System.out.println("NULL: " +
			 * node3.getHierarchy());
			 * 
			 * System.out.println(">>>>>>>>>>>>" + node3.getItem().getName() + " ("
			 * +node3.getItem().getPath()+ ") "); }); }); });
			 */
